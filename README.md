制作は今回が初めてで約3週間で制作しました。ローカル環境で制作し、使用したのはphp、mysql、html/cssです。今回はとりあえずきちんと動作をさせることを目標としたので、セキュリティやデザイン、使用性は考慮できていません。時間があればSQLインジェクションやXSSなどの対策やBootstrapやjavascriptの導入が考えていきたいです。
