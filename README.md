初めて制作物に挑戦し、約2週間で完成させました。ローカル環境で制作し、使用したのはphp、mysql、html/cssです。今回はとりあえずきちんと動作をさせることを目標としたので、セキュリティやデザイン、使用性は考慮できていません。時間があればSQLインジェクションやXSSなどの対策やBootstrapやjavascriptの導入も考えていきたいです。
